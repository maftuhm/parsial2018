...
<?php
    if(isset($_GET['id'])){
		...
		$sql_pemain = $conn->query("SELECT * FROM futsal_parsial WHERE email='$email'");
        $data_pemain = $sql_pemain->fetch_assoc();
        $id=$data_pemain['id'];
		$id_en = base64_encrypt($id,$key);
    }
?>
<?php require_once "functions/script_futsal1.php";?>
				...
				<form class="form-horizontal" id="submit_form" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-sm-12">
							...
							<h2>Formulir Pendaftaran Data Pemain</h2>
						...
						<div class="form-group">
							...
							<div class="col-md-6 aside-left">
								...
								<div class="form-group">
									...
									<label class="control-label col-md-offset-2 col-sm-offset-1 col-sm-3"><?php echo $i;?>. Nama <span class="required">* </span></label>

									<div class="col-sm-6">

										<input type="text" class="form-control" name="nama-pemain-<?php echo $i;?>" required />
								...
								<div class="form-group">
									...
									<label class="control-label  col-md-offset-2 col-sm-offset-1 col-sm-3">Foto <span class="required">* </span></label>
								...
								<div class="form-group">
									...
									<label class="control-label  col-md-offset-2 col-sm-offset-1 col-sm-3">Scan KTM <span class="required">* </span></label>

									<div class="col-sm-7">

										<input type="file" name="ktm-<?php echo $i;?>" required/>
							...
							<div class="col-md-6 aside-right">
								...
								<div class="form-group">
									...
									<label class="control-label col-sm-3"><?php echo $j;?>. Nama <span class="required">* </span></label>

									<div class="col-sm-6">

										<input type="text" class="form-control" name="nama-pemain-<?php echo $j;?>" required/>
								...
								<div class="form-group">
									...
									<label class="control-label col-sm-3">Foto <span class="required">* </span></label>

									<div class="col-sm-7">

										<input type="file" name="foto-<?php echo $j;?>" required/>
								...
								<div class="form-group">
									...
									<label class="control-label col-sm-3">Scan KTM <span class="required">* </span></label>

									<div class="col-sm-7">

										<input type="file" name="ktm-<?php echo $j;?>" required/>
						...
						<div class="form-group">
							...
							<?php 
								if (!$insert) {
										...
										echo '<a href="data-pemain2.php?id='.$id_en.'" class="btn btn-submit" type="submit">Lanjutkan</a>';
								}
							?>
