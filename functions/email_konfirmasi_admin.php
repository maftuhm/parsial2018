<?php 
    ...
    $select_data = $conn->query("SELECT * FROM admin WHERE pj_content=$pj_content");

    $data_a   = $select_data->fetch_assoc();

    $email_a = $data_a['email'];

    $nama_a  = $data_a['nama'];

    $tombol_email_a = 'Halaman Admin';

    $url_tombol_a = 'http://www.parsial.cf/panitia/';
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" style="border-top:1px solid #999999;border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                                            ...
                                                            <p style="font-family: sans-serif; font-size: 16px; font-weight: bold; margin: 15px 0;">Hai '.$nama_a.',</p>
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #222; border-radius: 5px; text-align: center;"> <a href="'.$url_tombol_a.'" target="_blank" style="display: block; color: #ffffff; background-color: #222; border: solid 1px #222; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 35px; text-transform: capitalize; border-color: #222;">'.$tombol_email_a.'</a> 
                                                            ...
                                                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin:15px 0;">Untuk informasi lebih lanjut tentang pengisian formullir dapat melalui halaman <a href="http://parsial.cf/contact-us.php" style="text-decoration: none;color: #999999">Contact Us</a> yang telah kami sediakan.</p>
                                                            ...
                                                            <p style="border-bottom:1px solid #999999;font-family: sans-serif; font-size: 14px; text-align: right; font-weight: normal; padding-bottom: 15px;padding-right: 15px"><em> - Web Developer</em></p>
    ...
    $headers[] = 'Bcc: maftuhsafii@gmail.com';


    // Mail it

    mail($email_a, $subject_a, $message_a, implode("\r\n", $headers_a));
