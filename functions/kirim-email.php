                                    ...
                                    <table class="main" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; background: #ffffff; border-radius: 3px;">
                                        ...
                                        <tr>
                                            <td class="wrapper" style="vertical-align: top; box-sizing: border-box;">
                                                ...
                                                <img style="max-width: 30%;margin:10px auto 0 auto; display: block;" src="https://parsial2018.000webhostapp.com/img/icon.png" >
                                        ...
                                        <tr>
                                            ...
                                            <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" style="border-top:1px dotted #999999;border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                                
                                                    <tr>
                                                        
                                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                                            
                                                            <p style="font-family: sans-serif; font-size: 16px; font-weight: bold; margin: 15px 0;">Hai '.$nama_penerima.',</p>
                                                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 15px 0;">'.$pesan.'</p>
                                                            
                                                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin:15px 0;"><a href="'.$url.'" style="text-decoration: none;color: #0000ff" target="_blank">'.$url.'</a></p>
                                                            ...
                                                            <p style="border-bottom:1px dotted #999999;font-family: sans-serif; font-size: 12px; text-align: left; font-weight: normal; padding-bottom: 15px;padding-right: 15px"> – '.$nama_pengirim.'</p>
