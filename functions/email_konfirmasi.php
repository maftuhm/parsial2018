<?php 
    ...
    $message_header = '
                                    ...
                                    <!-- START MAIN CONTENT AREA -->
                                        ...
                                        <tr>
                                            <td class="wrapper" style="vertical-align: top; text-align:center;box-sizing: border-box;">
                                                ...
                                                <h1>'.$judul_email.'</h1>
                                                <img style="max-width: 25%; margin: 10px auto; display: block;" src="https://parsial2018.000webhostapp.com/img/email/ceklis.png" >
                                            </td>
                                        </tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" style="border-top:1px solid #999999;border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                                            ...
                                                            <p style="font-family: sans-serif; font-size: 16px; font-weight: bold; margin: 15px 0;">Hai '.$nama.',</p>
        ...
        $message_footer = '
                                                            ...
                                                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin:15px 0;">Untuk informasi lebih lanjut tentang pengisian formullir dapat melalui halaman <a href="http://parsial.cf/contact-us.php" style="text-decoration: none;color: #999999" target="_blank">Contact Us</a> yang telah kami sediakan.</p>
